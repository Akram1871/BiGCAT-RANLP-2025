...
# Most of the code reused from https://github.com/urchade/GNNer repository

def run(model_name, epoch,batch_size,learning_rate, max_span, emb_width, project_dim):
	load_train_df = pd.read_pickle("train_fin5.pkl")
	load_test_df = pd.read_pickle("test_fin3.pkl")
